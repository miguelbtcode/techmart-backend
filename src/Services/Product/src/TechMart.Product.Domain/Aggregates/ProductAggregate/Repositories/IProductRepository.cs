...
namespace TechMart.Product.Domain.Aggregates.ProductAggregate.Repositories;
...
public interface IProductRepository : IRepository<Entities.Product, Guid>
{
    ...
    Task<Entities.Product?> GetBySkuAsync(ProductSku sku, CancellationToken cancellationToken = default);
    ...
    Task<Entities.Product?> GetBySkuWithDetailsAsync(ProductSku sku, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetByCategoryAsync(Guid categoryId, bool includeInactive = false, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetByCategoriesAsync(IEnumerable<Guid> categoryIds, bool includeInactive = false, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetByBrandAsync(Guid brandId, bool includeInactive = false, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetByBrandsAsync(IEnumerable<Guid> brandIds, bool includeInactive = false, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetByStatusAsync(ProductStatus status, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetFeaturedProductsAsync(int limit = 10, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> SearchAsync(string searchText, bool includeInactive = false, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetByPriceRangeAsync(decimal minPrice, decimal maxPrice, bool includeInactive = false, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetOnSaleProductsAsync(CancellationToken cancellationToken = default);
    ...
    Task<PagedList<Entities.Product>> GetPagedAsync(int pageNumber, int pageSize, CancellationToken cancellationToken = default);
    ...
    Task<PagedList<Entities.Product>> GetPagedAsync(Expression<Func<Entities.Product, bool>> predicate, int pageNumber, int pageSize, CancellationToken cancellationToken = default);
    ...
    Task<PagedList<Entities.Product>> GetPagedByCategoryAsync(Guid categoryId, int pageNumber, int pageSize, bool includeInactive = false, CancellationToken cancellationToken = default);
    ...
    Task<PagedList<Entities.Product>> GetPagedByBrandAsync(Guid brandId, int pageNumber, int pageSize, bool includeInactive = false, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetRecentlyAddedAsync(int days = 7, int limit = 10, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetRecentlyUpdatedAsync(int days = 7, int limit = 10, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetTopRatedAsync(int limit = 10, int minReviewCount = 5, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetLowStockProductsAsync(int threshold = 10, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetProductsNeedingReviewAsync(CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetBySpecificationAsync(Expression<Func<Entities.Product, bool>> specification, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetWithVariantsAsync(IEnumerable<Guid> productIds, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetWithImagesAsync(IEnumerable<Guid> productIds, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Entities.Product>> GetWithReviewsAsync(IEnumerable<Guid> productIds, CancellationToken cancellationToken = default);
