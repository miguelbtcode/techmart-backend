...
namespace TechMart.Product.Domain.Aggregates.ProductAggregate.Specifications;
...
public static class ProductSpecifications
{
    ...
    public static Expression<Func<Entities.Product, bool>> IsActive()
    {
    ...
    public static Expression<Func<Entities.Product, bool>> HasStatus(ProductStatus status)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> InCategory(Guid categoryId)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> OfBrand(Guid brandId)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> OfType(ProductType productType)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> IsFeatured()
    {
    ...
    public static Expression<Func<Entities.Product, bool>> IsOnSale()
    {
    ...
    public static Expression<Func<Entities.Product, bool>> InPriceRange(decimal minPrice, decimal maxPrice)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> HasMinimumRating(double minRating)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> HasMinimumReviews(int minReviewCount)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> HasSku(string sku)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> ContainsText(string searchText)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> CreatedBetween(DateTime startDate, DateTime endDate)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> UpdatedBetween(DateTime startDate, DateTime endDate)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> IsDigital()
    {
    ...
    public static Expression<Func<Entities.Product, bool>> IsPhysical()
    {
        return product => !product.IsDigital;
    }
    ...
    public static Expression<Func<Entities.Product, bool>> RequiresShipping()
    {
    ...
    public static Expression<Func<Entities.Product, bool>> HasVariants()
    {
    ...
    public static Expression<Func<Entities.Product, bool>> HasImages()
    {
    ...
    public static Expression<Func<Entities.Product, bool>> HasAttribute(string attributeName, string? attributeValue = null)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> CreatedBy(string userId)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> UpdatedBy(string userId)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> WeightBetween(decimal minWeight, decimal maxWeight)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> HasMinimumDiscount(decimal minDiscountPercentage)
    {
        return product => product.CompareAtPrice != null && 
                         product.CompareAtPrice.Amount > product.Price.Amount &&
    ...
    public static Expression<Func<Entities.Product, bool>> AddedRecently(int days = 7)
    {
    ...
    public static Expression<Func<Entities.Product, bool>> HasApprovedReviews()
    {
